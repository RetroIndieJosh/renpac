...
init python:
    ...
    cursor_filenames = list(filter(
        lambda file_name: 
            file_name.startswith("gui/cursors") and file_name.endswith(".png"), 
        renpy.list_files()))
...
define config.save_directory = "bardolf-1677272970"
...
# define build.itch_project = "retroindiejosh/renpac"
