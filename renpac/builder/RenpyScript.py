...
class RenpyScript:
    ...
    def add_call(self, call: python.Call):
        self.add_python(call.to_python())
...
if __name__ == "__main__":
    ...
    if line_count == EXPECTED_LINES:
        ...
        print(
            f"Something went wrong. Expected {EXPECTED_LINES} lines but wrote {line_count}.")
